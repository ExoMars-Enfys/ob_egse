...
def main() -> None:
    ...
    if args.script:
        ...
        abu.mv_abs_pos(ob_port, 1200)
        abu.move_and_measure(ob_port, 0, sci_adc_samp=4, sci_adc_skip=100)
        for i in range(1200, 9960, 30):
            abu.move_and_measure(ob_port, 30, sci_adc_samp=4, sci_adc_skip=100)
