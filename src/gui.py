...
# st.logo("C:/wdir/DEV/ob_egse/rsrc/ExoMars_Logo_PNG.png",size = "large")
...
def get_mtr_hk(port,last_hk) : 
    try:
        ...
        st.subheader("MOTOR ERRORS")
        col1, col2, col3, col4, col5, col6 = st.columns(6)
        col1.metric("UNUSED",value = last_hk.MTR_ERRORS.UNUSED,delta = None,delta_color="normal",help=None,label_visibility="visible",border=True)
        col2.metric("CD",value = last_hk.MTR_ERRORS.CD,delta = None,delta_color="normal",help=None,label_visibility="visible",border=True)
        col3.metric("AB",value = last_hk.MTR_ERRORS.AB,delta = None,delta_color="normal",help=None,label_visibility="visible",border=True)
        col4.metric("ABS STEP ERROR",value = last_hk.MTR_ERRORS.ABS,delta = None,delta_color="normal",help=None,label_visibility="visible",border=True)
        col5.metric("REL STEP ERROR",value = last_hk.MTR_ERRORS.REL,delta = None,delta_color="normal",help=None,label_visibility="visible",border=True)
        col6.metric("DSE",value = last_hk.MTR_ERRORS.DSE,delta = None,delta_color="normal",help=None,label_visibility="visible",border=True)
        return last_hk
    except IndexError:
        st.write("No HK data available")
