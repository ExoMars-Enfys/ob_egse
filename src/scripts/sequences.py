...
def check_sci(port, sci_adc_samp, sci_adc_skip):
    ...
    event_log.info(
        ...
        f"  SWIR_HIGH: {resp.SWIR_HIGH:04x}" +
        f"  SWIR_MED: {resp.SWIR_MED:04x}" +
        f"  SWIR_LOW: {resp.SWIR_LOW:04x}" +
        f"  MWIR_HIGH: {resp.MWIR_HIGH:04x}" +
        f"  MWIR_MED: {resp.MWIR_MED:04x}" +
        f"  MWIR_LOW: {resp.MWIR_LOW:04x}" +
