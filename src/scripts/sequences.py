...
def parse_hk(port):
    ...
    event_log.info(
        ...
        + f"\n HK_V_3V3 : {resp.HK_V_3V3}, (12-bit {resp.HK_V_3V3 >> 4})"
        + f"\n HK_V_1V5 : {resp.HK_V_1V5} (12-bit {resp.HK_V_1V5 >> 4})"
        + f"\n DIGITAL_TRP : {resp.DIGITAL_TRP} (12-bit {resp.DIGITAL_TRP >> 4})"
        + f"\n DETEC_TRP : {resp.DETEC_TRP} (12-bit {resp.DETEC_TRP >> 4})"
        + f"\n MECH_TRP : {resp.MECH_TRP} (12-bit {resp.MECH_TRP >> 4})"
        + f"\n MOTOR_TRP : {resp.MOTOR_TRP} (12-bit {resp.MOTOR_TRP >> 4})"
        + f"\n HK_MECH_CUR : {resp.HK_MECH_CUR} (12-bit {resp.HK_MECH_CUR >> 4})"
