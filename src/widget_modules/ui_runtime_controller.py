...
def perform_hk_check(hk: Any = None, post: Any = None, hk_type: str = "hk") -> dict:
    ...
    if hk_type == "hk":
        ...
        all_post_passed = (
            ...
            and getattr(post, "ASW_IMAGE_1_CRC", None) == 0xFA14
            and getattr(post, "ASW_IMAGE_2_CRC", None) == 0x7554
            and getattr(post, "ASW_IMAGE_3_CRC", None) == 0xFF8B
            and getattr(post, "ASW_IMAGE_4_CRC", None) == 0x8D00
            and getattr(post, "ASW_IMAGE_5_CRC", None) == 0xF12A
