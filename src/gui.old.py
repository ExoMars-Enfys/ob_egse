...
def st_psu_toggle(psuport: serial.Serial):
    psu.open_psu_comms(psuport, nopsurequired=False)
...
def get_sci():
    try:
        ...
        # col2.metric('Thermal Status', last_sci.THRM_STATUS_BYTE, delta=None, delta_color="normal", help=None, label_visibility="visible", border=False)
